...
EXP_GEN_RSYNC = [
    '# Sync files',
    f'rsync -truOv {SWD}/data/src/dir1 {DDP} $log ' + '--exclude={*/venv*,*/__.*}',
    ...
    'fi',
    f'rsync -truOv {SWD}/data/src/g.xml {DDP} $log',
    f'rsync -truOv {SWD}/data/src/'+'{h.go,l.doc} tests/data/tgt/dir1/conf $log',
    ''
]
